...
type openAICompatibilityWithAuthIndex struct {
	...
	AppendReasoningEffortToModelPercent *int                                     `json:"append-reasoning-effort-to-model-percent,omitempty"`
	AuthIndex                           string                                   `json:"auth-index,omitempty"`
}
...
func (h *Handler) openAICompatibilityWithAuthIndex() []openAICompatibilityWithAuthIndex {
	...
	for i := range normalized {
		...
		response := openAICompatibilityWithAuthIndex{
			...
			AppendReasoningEffortToModel:        entry.AppendReasoningEffortToModelEnabled(),
			AppendReasoningEffortToModelPercent: entry.AppendReasoningEffortToModelPercent,
			AuthIndex:                           "",
		}
