...
// shortenCodexCallIDIfNeeded keeps Claude tool IDs within OpenAI Responses
// call_id limits while preserving deterministic mapping for cached tool-call
// replay and continuation validation.
